...
public slots:
    ...
    void push_button_run_clicked()
    {
        ...
        for (int i = 0; i<int(input_queries_.size());i+=1)
        {
            ...
            exec_select_query(connection, QString::fromStdString(input_queries_.at(i)), models_.at(i));
...
private:
    ...
    void exec_select_query(NB_HANDLE connection, QString query, QStandardItemModel* model)
    {
